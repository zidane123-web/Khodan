...
class InMemoryAnimalRepository implements AnimalRepository {
  ...
  final List<Animal> _animals = <Animal>[
    Animal(
      ...
      lastLitterDate: DateTime.now().subtract(const Duration(days: 45)),
      nextTaskDate: DateTime.now().add(const Duration(days: 12)),
      notes: 'Reproductrice principale',
    ),
    Animal(
      id: 'doe-002',
      profileId: 'demo-profile',
      ...
      lastLitterDate: DateTime.now().subtract(const Duration(days: 32)),
      nextTaskDate: DateTime.now().add(const Duration(days: 5)),
      notes: 'En observation sur la prise en lait',
    ),
    Animal(
      id: 'buck-001',
      profileId: 'demo-profile',
      ...
      sex: 'Male',
      status: 'Actif',
      breed: 'Geant des Flandres',
      category: 'Reproducteur',
      cageNumber: 'C-205',
      origin: 'Elevage interne',
      entryDate: DateTime.now().subtract(const Duration(days: 470)),
      lastLitterDate: DateTime.now().subtract(const Duration(days: 60)),
      notes: 'Excellent taux de fertilite',
    ),
    Animal(
      id: 'buck-002',
      profileId: 'demo-profile',
      ...
      nextTaskDate: DateTime.now().add(const Duration(days: 30)),
      notes: 'Prevu pour rotation en decembre',
    ),
    Animal(
      id: 'doe-003',
      profileId: 'demo-profile',
