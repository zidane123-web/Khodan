...
enum SyncActionType {
  ...
  createTaskTemplate('taskTemplate.create'),
  updateTaskTemplate('taskTemplate.update'),
  deleteTaskTemplate('taskTemplate.delete'),
  createTaskTemplateAssignment('taskTemplateAssignment.create'),
  updateTaskTemplateAssignment('taskTemplateAssignment.update'),
  deleteTaskTemplateAssignment('taskTemplateAssignment.delete'),
  createHealthRecord('healthRecord.create'),
  updateHealthRecord('healthRecord.update'),
  deleteHealthRecord('healthRecord.delete'),
  createHealthTreatment('healthTreatment.create'),
  updateHealthTreatment('healthTreatment.update'),
  deleteHealthTreatment('healthTreatment.delete'),
  ...
  createLitter('litter.create'),
  updateLitterBatch('litter.updateBatch'),
  saveLitterWeights('litter.saveWeights'),
